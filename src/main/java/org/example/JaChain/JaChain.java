...
public class JaChain {
    ...
    public static void main(String[] args){
        ...
        // Create Genesis Transaction, which sends 100 JaCoin to walletA
        // Manually add some params
        ...
        System.out.println("\nWalletB attempting to send more funds (20) to WalletA...");
    ...
    public static Boolean isChainValid() {
        ...
        for (int i = 1; i< blockchain.size(); i++){
            ...
            for (int t = 0; t < currentBlock.transactions.size(); t++){
                ...
                if (currentTransaction.outputs.getFirst().recipient != currentTransaction.reciepient){
    ...
    public static void displayWalletsBalance(){
        System.out.println("\nWalletA's balance is: " + walletA.getBalance());
